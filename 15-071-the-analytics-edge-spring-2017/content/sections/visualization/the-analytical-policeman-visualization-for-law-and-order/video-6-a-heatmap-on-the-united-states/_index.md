...
In this video, we'll be using the dataset [murders (CSV)](/coursemedia/15-071-the-analytics-edge-spring-2017/36129924d80acf17557ee219a6c3c79c_murders.csv). This data is provided by the U.S. Census Bureau and the FBI, and is decribed [in this Wikipedia entry about gun violence in the U.S. by state.](http://en.wikipedia.org/wiki/Gun_violence_in_the_United_States_by_state). 
